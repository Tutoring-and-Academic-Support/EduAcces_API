...
INSERT INTO estudiante (user_id, ciclo, nombre, password, email) VALUES
...
INSERT INTO tutor (user_id, departamento, nombre, password, email) VALUES
...
INSERT INTO comentario (texto, fecha, curso_id) VALUES
                                                    ('Este curso es muy bueno para entender las matemáticas básicas.', CURRENT_TIMESTAMP, (SELECT id FROM curso WHERE nombre_curso = 'Matemáticas Básicas')),
                                                    ('El curso de física avanzada es excelente, pero requiere dedicación.', CURRENT_TIMESTAMP, (SELECT id FROM curso WHERE nombre_curso = 'Física Avanzada')),
                                                    ('Me encanta la manera en que se enseña la programación en este curso.', CURRENT_TIMESTAMP, (SELECT id FROM curso WHERE nombre_curso = 'Introducción a la Programación'))
